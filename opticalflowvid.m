...
fx = conv2(im1, 0.125*[-1 -1 1 1;-1 -1 1 1]) + conv2(im2, 0.125*[-1 -1 1 1; -1 -1 1 1]);
fy = conv2(im1, 0.125*[-1 -1 -1 -1;1 1 1 1]) + conv2(im2, 0.125*[-1 -1 -1 -1;1 1 1 1]);
ft = conv2(im1, 0.125*ones(4)) + conv2(im2, -0.125*ones(4));
